...
var RegisteredFuncs = make(map[string]*types.SimpleFunc) // must initialize
...
func Register(name string, fn *types.SimpleFunc) {
...
func ModuleRegister(module, name string, fn *types.SimpleFunc) {
